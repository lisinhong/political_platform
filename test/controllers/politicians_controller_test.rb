...
class PoliticiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politician" do
    assert_difference('Politician.count') do
      post politicians_url, params: { politician: { age: @politician.age, birth: @politician.birth, city: @politician.city, experience: @politician.experience, gender: @politician.gender, name: @politician.name, party: @politician.party, region: @politician.region, school: @politician.school } }
    end
  ...
  test "should update politician" do
    patch politician_url(@politician), params: { politician: { age: @politician.age, birth: @politician.birth, city: @politician.city, experience: @politician.experience, gender: @politician.gender, name: @politician.name, party: @politician.party, region: @politician.region, school: @politician.school } }
