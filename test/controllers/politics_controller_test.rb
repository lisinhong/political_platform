...
class PoliticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create politic" do
    assert_difference('Politic.count') do
      post politics_url, params: { politic: { description: @politic.description, politician_id: @politic.politician_id } }
    end
  ...
  test "should update politic" do
    patch politic_url(@politic), params: { politic: { description: @politic.description, politician_id: @politic.politician_id } }
